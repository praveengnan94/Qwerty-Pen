   ...
   0000                     418 	.ds 8
                            ...
                            472 	.area CSEG    (CODE)
                            473 ;------------------------------------------------------------
                            474 ;Allocation info for local variables in function 'pen_down'
                            475 ;------------------------------------------------------------
                            476 ;exit                      Allocated with name '_pen_down_exit_1_1'
                            477 ;------------------------------------------------------------
                            478 ;	servo.c:3: void pen_down(void)           //servo motor control
                            479 ;	-----------------------------------------
                            480 ;	 function pen_down
                            481 ;	-----------------------------------------
   1079                     482 _pen_down:
                    0002    483 	ar2 = 0x02
                    0003    484 	ar3 = 0x03
                    ...
                    0000    489 	ar0 = 0x00
                    0001    490 	ar1 = 0x01
                            491 ;	servo.c:6: while(exit!=0)          //1.5 ms step neutral   WORKING
                            492 ;	genAssign
   1079 7A 05               493 	mov	r2,#0x05
   107B 7B 00               494 	mov	r3,#0x00
   107D                     495 00101$:
                            496 ;	genCmpEq
                            497 ;	gencjneshort
   107D BA 00 04            498 	cjne	r2,#0x00,00109$
   1080 BB 00 01            499 	cjne	r3,#0x00,00109$
                            500 ;	Peephole 112.b	changed ljmp to sjmp
                            501 ;	Peephole 251.b	replaced sjmp to ret with ret
   1083 22                  502 	ret
   1084                     503 00109$:
                            504 ;	servo.c:8: SERVO_STEP =1;
                            505 ;	genAssign
   1084 D2 95               506 	setb	_P1_5
                            507 ;	servo.c:9: delay_ms(1);
                            508 ;	genCall
                            509 ;	Peephole 182.b	used 16 bit load of dptr
   1086 90 00 01            510 	mov	dptr,#0x0001
   1089 C0 02               511 	push	ar2
   108B C0 03               512 	push	ar3
   108D 12 05 46            513 	lcall	_delay_ms
   1090 D0 03               514 	pop	ar3
   1092 D0 02               515 	pop	ar2
                            516 ;	servo.c:10: delay_us(35);
                            517 ;	genCall
                            518 ;	Peephole 182.b	used 16 bit load of dptr
   1094 90 00 23            519 	mov	dptr,#0x0023
   1097 C0 02               520 	push	ar2
   1099 C0 03               521 	push	ar3
   109B 12 05 13            522 	lcall	_delay_us
   109E D0 03               523 	pop	ar3
   10A0 D0 02               524 	pop	ar2
                            525 ;	servo.c:11: SERVO_STEP =0;
                            526 ;	genAssign
   10A2 C2 95               527 	clr	_P1_5
                            528 ;	servo.c:12: delay_ms(18);
                            529 ;	genCall
                            530 ;	Peephole 182.b	used 16 bit load of dptr
   10A4 90 00 12            531 	mov	dptr,#0x0012
   10A7 C0 02               532 	push	ar2
   10A9 C0 03               533 	push	ar3
   10AB 12 05 46            534 	lcall	_delay_ms
   10AE D0 03               535 	pop	ar3
   10B0 D0 02               536 	pop	ar2
                            537 ;	servo.c:13: exit --;
                            538 ;	genMinus
                            539 ;	genMinusDec
   10B2 1A                  540 	dec	r2
   10B3 BA FF 01            541 	cjne	r2,#0xff,00110$
   10B6 1B                  542 	dec	r3
   10B7                     543 00110$:
                            544 ;	Peephole 112.b	changed ljmp to sjmp
   10B7 80 C4               545 	sjmp	00101$
                            546 ;	Peephole 259.a	removed redundant label 00104$ and ret
                            547 ;
                            548 ;------------------------------------------------------------
                            549 ;Allocation info for local variables in function 'pen_up'
                            550 ;------------------------------------------------------------
                            551 ;exit                      Allocated with name '_pen_up_exit_1_1'
                            552 ;------------------------------------------------------------
                            553 ;	servo.c:18: void pen_up(void)       //servo motor control
                            554 ;	-----------------------------------------
                            555 ;	 function pen_up
                            556 ;	-----------------------------------------
   10B9                     557 _pen_up:
                            558 ;	servo.c:21: while(exit!=0)
                            559 ;	genAssign
   10B9 7A 05               560 	mov	r2,#0x05
   10BB 7B 00               561 	mov	r3,#0x00
   10BD                     562 00101$:
                            563 ;	genCmpEq
                            564 ;	gencjneshort
   10BD BA 00 04            565 	cjne	r2,#0x00,00109$
   10C0 BB 00 01            566 	cjne	r3,#0x00,00109$
                            567 ;	Peephole 112.b	changed ljmp to sjmp
                            568 ;	Peephole 251.b	replaced sjmp to ret with ret
   10C3 22                  569 	ret
   10C4                     570 00109$:
                            571 ;	servo.c:23: SERVO_STEP =1;
                            572 ;	genAssign
   10C4 D2 95               573 	setb	_P1_5
                            574 ;	servo.c:24: delay_us(35);
                            575 ;	genCall
                            576 ;	Peephole 182.b	used 16 bit load of dptr
   10C6 90 00 23            577 	mov	dptr,#0x0023
   10C9 C0 02               578 	push	ar2
   10CB C0 03               579 	push	ar3
   10CD 12 05 13            580 	lcall	_delay_us
   10D0 D0 03               581 	pop	ar3
   10D2 D0 02               582 	pop	ar2
                            583 ;	servo.c:25: delay_us(30);
                            584 ;	genCall
                            585 ;	Peephole 182.b	used 16 bit load of dptr
   10D4 90 00 1E            586 	mov	dptr,#0x001E
   10D7 C0 02               587 	push	ar2
   10D9 C0 03               588 	push	ar3
   10DB 12 05 13            589 	lcall	_delay_us
   10DE D0 03               590 	pop	ar3
   10E0 D0 02               591 	pop	ar2
                            592 ;	servo.c:26: SERVO_STEP =0;
                            593 ;	genAssign
   10E2 C2 95               594 	clr	_P1_5
                            595 ;	servo.c:27: delay_ms(18);
                            596 ;	genCall
                            597 ;	Peephole 182.b	used 16 bit load of dptr
   10E4 90 00 12            598 	mov	dptr,#0x0012
   10E7 C0 02               599 	push	ar2
   10E9 C0 03               600 	push	ar3
   10EB 12 05 46            601 	lcall	_delay_ms
   10EE D0 03               602 	pop	ar3
   10F0 D0 02               603 	pop	ar2
                            604 ;	servo.c:28: exit--;
                            605 ;	genMinus
                            606 ;	genMinusDec
   10F2 1A                  607 	dec	r2
   10F3 BA FF 01            608 	cjne	r2,#0xff,00110$
   10F6 1B                  609 	dec	r3
   10F7                     610 00110$:
                            611 ;	Peephole 112.b	changed ljmp to sjmp
   10F7 80 C4               612 	sjmp	00101$
                            613 ;	Peephole 259.a	removed redundant label 00104$ and ret
                            614 ;
                            615 	.area CSEG    (CODE)
                            616 	.area CONST   (CODE)
                            617 	.area XINIT   (CODE)
