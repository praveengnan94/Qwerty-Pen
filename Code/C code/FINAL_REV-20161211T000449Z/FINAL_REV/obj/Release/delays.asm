...
;------------------------------------------------------------
;	delays.c:3: void delay_us(unsigned int us_count)
;	-----------------------------------------
;	 function delay_us
;	-----------------------------------------
_delay_us:
...
;------------------------------------------------------------
;	delays.c:11: void delay_ms(unsigned int ms_count)
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00108$
00109$:
;	delays.c:15: delay_us(52);	 //delay_us is called to generate 1ms delay
;	genCall
...
;------------------------------------------------------------
;	delays.c:21: void delay_sec(unsigned char sec_count)
;	-----------------------------------------
;	 function delay_sec
;	-----------------------------------------
_delay_sec:
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00108$
00109$:
;	delays.c:25: delay_ms(1000);	//delay_ms is called to generate 1sec delay
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x03E8
	push	ar2
