...
.equ	vector, 0x2000		;location to LJMP interrupt vectors---EDITED FROM 2000
...
.equ	pgm, 0x3000		;default location for the user program
.equ	bmem, 0x0000		;where is the beginning of memory; EDITED
